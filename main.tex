...
\newcommand\pfunction[2]{\texttt{#2}\index{Module Python!#1!#2}\reversemarginpar\marginnote{\textcolor{green!50!black}{#2}}\normalmarginpar\marginnote{\textcolor{green!50!black}{#1}}}

% boot.py

\newcommand\glos[1]{\gls{#1}\index{#1}}
\newcommand\pprog[1]{\href{https://github.com/ltn22/The-book-of-SCHC/blob/main/Programs/#1}{\texttt{#1}}\index{Programmes!#1}}
...
\newcommand\Index[1]{#1\index{#1}\reversemarginpar\marginnote{\textcolor{blue}{\textrm{#1}}}\normalmarginpar}
\newcommand\Indexr[1]{#1\index{#1}\marginnote{\textcolor{blue}{\textrm{#1}}}}
\newcommand\Indexs[1]{#1\index{#1}}
\newcommand\marge[1]{\reversemarginpar\marginnote{\textcolor{blue}{\textrm{#1}}}\normalmarginpar}
...
\vspace*{1cm}
{\Huge Ivan MARTINEZ, Laurent TOUTAIN}\par % Author name
\endgroup
