\begin{lstlisting}[language=Python, caption={Program ping\_device2.py}, label=prog-ping-device2, basicstyle=\ttfamily\tiny]
import sys
            ...
            if ip_proto == 17:
                ...
                if udp_dport == socket_port: # tunnel SCHC msg to be decompressed
                    ...
                    if rule[T_RULEID] == 6 and rule[T_RULEIDLENGTH]== 3:
                        ...
                        # None when the reassembly + decompressing process is not finished and 
                        # [device_id, decompressed packet in bytes] when All-1
